                        ...
                        <form action="action/update_exam_post.php" method="post" enctype="multipart/form-data">
                            <div class="container content">
                                <div class="sec-title mb-3 text-center">
                                    <h2 class="mb-0">UPDATE EXAM DETAIL</h2>
                                </div>
                                        ...
                                        foreach ($value as $key1 => $value1) {
                                            ...
                                            <p>
                                                ...
                                                <input type="text" name="exam_name"
                                                    value="<?php echo $value1->exam_name; ?>" class="form-control"
                                                    required />
                                            </p>
                                            <p>
                                                <strong>Exam Course :</strong> <br />
                                                <select name="exam_course" class="form-control" required>
                                                    <option value="<?php echo $value1->exam_course; ?>" selected>Selected:
                                                    ...
                                                    <option value="Diploma In Basic Programming (DBP) (6 Months)">Diploma In
                                                        Basic Programming (DBP) (6
                                                        Months)</option>
                                                    <option value="Tally Prime With GST (3 Months)">Tally Prime With GST (3
                                                        Months)</option>
                                                    <option value="Diploma In Mobile Maintenance (DMM) (6 Months)">Diploma In
                                                        Mobile Maintenance (DMM)
                                                        (6 Months)</option>
                                                    ...
                                                    <option value="Tally Prime With GST (6 Months)">Tally Prime With GST (6
                                                        Months)</option>
                                                    <option value="Office Management Course (3 Months)">Office Management Course
                                                        (3 Months)</option>
                                            ...
                                            <p>
                                                ...
                                                <input type="text" name="no_question" value="<?php echo $value1->no_question ;?>" class="form-control" required />
                                            </p>
                                            <p>
