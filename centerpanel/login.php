...
<body>
    ...
    <div class="container">
        <div class="login">
            <form action="action/franchise_login_post.php" method="post" accept-charset="utf-8">
                <h1 align="center">Center Login</h1>
                <div class="inp">
                    <strong>Email :</strong> <br />
                    <input type="email" name="login_email" value="" class="form-control" placeholder="Email" />
                    <br />
