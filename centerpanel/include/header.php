...
<?php
if (isset($_SESSION["FRANCHISE_ID"]) and isset($_SESSION["FRANCHISE_NAME"]) and isset($_SESSION["FRANCHISE_EMAIL"]) and isset($_SESSION["FRANCHISE_PASSWORD"])) {
...
<head>
    ...
    <title>Center Panel - <?php $_SESSION['FRANCHISE_NAME']; ?> </title>
    <!-- Favicon icon-->
                        ...
                        <li class="dropdown ms-4">
                            ...
                            <div class="dropdown-menu dropdown-menu-end p-0">
                                ...
                                <div class="lh-1 px-5 py-4 border-bottom">
                                    <h5 class="mb-1 h6">
                                        <?php echo $_SESSION["FRANCHISE_NAME"]; ?>
                                    </h5>
                                    <small>
                                        <?php echo $_SESSION["FRANCHISE_EMAIL"]; ?>
                                    </small>
                                </div>
