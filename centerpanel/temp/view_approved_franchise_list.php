                  ...
                  <tr>
                    ...
                    foreach ($result as $key => $value) {
                      foreach ($value as $key1 => $value1) {
                        ...
                        <td>
                          <?php echo $value1->login_password; ?>
                        </td>
                        <td>
                        ...
                        <td>
                          <form action="action/delete_franchise_post.php" method="post">
                            <input type="hidden" name="id" value="<?php echo $value1->id ?>">
                            <button type="submit" name="delete_franchise" class="btn btn-sm btn-danger"><i
