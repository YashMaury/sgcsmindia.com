...
<div class="achivements" style="background: url(assets/images/slide/breadcrumb.jpg);padding: 50px;">
    <div class="sec-title mb-3 text-center">
        <h2 class="mb-0" style="color:#fff;">RULES & REGULATION</h2>
        <p style="color:#fff;">Home / Rules & Regulation</p>
    </div>
    <div class="container">
        <div class="row">
...
<div class="container content">
    ...
    <h2 style="padding: 10px;">RULES & REGULATIONS</h2>
    <div class="row">
        <div class="col-sm-9">
            ...
            <p>
                <i class="bi bi-chevron-double-right"></i>
                GICT will not receive any kind of Cash Amount from Center Director & All Charges will be accepted by
                Net Banking (SBI &PNB) in favor of “Sanjay Gandhi Computer Saksharta Mission”.
            </p>

            <p>
                <i class="bi bi-chevron-double-right"></i>
                Free Education to physically handicapped students.
            </p>
