! function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(require("bootstrap")) : "function" == typeof define && define.amd ? define("Lightbox", ["bootstrap"], e) : "object" == typeof exports ? exports.Lightbox = e(require("bootstrap")) : t.Lightbox = e(t.bootstrap)
}(self, (function(t) {
    return function() {
        "use strict";
        var e = {
        ...
        return function() {
            ...
            class s {
                constructor(t, s = {}) {
                    this.hash = this.randomHash(), this.settings = Object.assign(Object.assign(Object.assign({}, e.Modal.Default), e.Carousel.Default), {
                        interval: !1,
                ...
                getGalleryItems() {
                    ...
                    return t ? [...new Set(Array.from(document.querySelectorAll(`[data-gallery="${t}"]`), (t => `${t.dataset.type?t.dataset.type:""}${this.getSrc(t)}`)))] : [`${this.type?this.type:""}${this.src}`]
                }
                getYoutubeId(t) {
                    if (!t) return !1;
                ...
                getYoutubeLink(t) {
                    ...
                    if (!e) return !1;
                    const s = t.split("?");
                    return `https://www.youtube.com/embed/${e}${s.length>1?"?"+s[1]:""}`
                }
                getInstagramEmbed(t) {
                ...
                isEmbed(t) {
                    const e = new RegExp("(" + s.allowedEmbedTypes.join("|") + ")").test(t),
                        a = /\.(png|jpe?g|gif|svg|webp)/i.test(t) || "image" === this.el.dataset.type;
                    return e || !a
                }
                createCarousel() {
                    const t = document.createElement("template"),
                        a = s.allowedMediaTypes.join("|"),
                        o = this.sources.map(((t, e) => {
                            t = t.replace(/\/$/, "");
                            ...
                            if (r.get("caption")) {
                                try {
                                    d = new URL(t), d.searchParams.delete("caption"), d = d.toString()
                                } catch (e) {
                                    d = t
                                }
                                l = `<p class="lightbox-caption m-0 p-2 text-center text-white small"><em>${r.get("caption")}</em></p>`
                            }
                            let c = `<img src="${d}" class="d-block ${n} img-fluid" style="z-index: 1; object-fit: contain;" />`,
                                h = "";
              ...
              <div class="spinner-border" style="width: 3rem height: 3rem" role="status"></div>
                    ...
                    t.innerHTML = r.trim(), this.carouselElement = t.content.firstChild;
                    const l = Object.assign(Object.assign({}, this.carouselOptions), {
                        keyboard: !1
                    });
                    this.carousel = new e.Carousel(this.carouselElement, l);
                    const d = this.type && "image" !== this.type ? this.type + this.src : this.src;
                    return this.carousel.to(this.findGalleryItemIndex(this.sources, d)), !0 === this.carouselOptions.keyboard && document.addEventListener("keydown", (t => {
                        if ("ArrowLeft" === t.code) {
                            const t = document.getElementById(`#lightboxCarousel-${this.hash}-prev`);
                            return t && t.click(), !1
                        }
                        if ("ArrowRight" === t.code) {
                            const t = document.getElementById(`#lightboxCarousel-${this.hash}-next`);
                            return t && t.click(), !1
                        }
                    })), this.carousel
                }
                ...
                createModal() {
                    const t = document.createElement("template"),
                        s = `\n\t\t\t<div class="modal lightbox fade" id="lightboxModal-${this.hash}" tabindex="-1" aria-hidden="true">\n\t\t\t\t<div class="modal-dialog modal-dialog-centered modal-${this.settings.size}">\n\t\t\t\t\t<div class="modal-content border-0 bg-transparent">\n\t\t\t\t\t\t<div class="modal-body p-0">\n\t\t\t\t\t\t\t<button type="button" class="btn-close position-absolute top-0 end-0 p-3" data-bs-dismiss="modal" aria-label="Close" style="z-index: 2; background: none;"><svg xmlns="http://www.w3.org/2000/svg" style="position: relative; top: -5px;" viewBox="0 0 16 16" fill="#fff">
            ...
            s.allowedEmbedTypes = ["embed", "youtube", "vimeo", "instagram", "url"], s.allowedMediaTypes = [...s.allowedEmbedTypes, "image", "html"], s.defaultSelector = '[data-toggle="lightbox"]', s.initialize = function(t) {
                t.preventDefault();
                new s(this).show()
            }, document.querySelectorAll(s.defaultSelector).forEach((t => t.addEventListener("click", s.initialize))), "undefined" != typeof window && window.bootstrap && (window.bootstrap.Lightbox = s), o.default = s
        }(), o = o.default
    }()
}));