                  ...
                  <table class="table table-centered table-hover text-nowrap table-borderless mb-0 table-with-checkbox">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a href="#" class="text-reset"><?php echo $value1->image_title; ?> </a></td>

                        <td><?php echo $value1->image_description; ?></td>
                        
                        <td>
                            <a href="<?php echo $image; ?>" data-toggle="lightbox" data-gallery="admin-image-gallery" data-caption="<?php echo $value1->image_description; ?>">
