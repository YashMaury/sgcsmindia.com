                ...
                <div class="card mb-6 shadow border-0">
                    <div class="card-body p-6 ">
                        ...
                        <form action="action/upload_galleryimg_post.php" method="post" enctype="multipart/form-data">
                            ...
                            <h4 class="mb-4 h5 mt-5">Image Information<?php //echo $_SESSION['ADMIN_ID'];?></h4>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-lg-6">
                                    ...
                                    <textarea type="text" class="form-control" name="image_description"
                                        placeholder="Image Description" required></textarea>
                                </div>
